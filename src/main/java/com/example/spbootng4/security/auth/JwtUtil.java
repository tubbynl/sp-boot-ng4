...
public class JwtUtil implements Serializable {
    ...
    public JwtUtil(
      @Value("${auth.secret:#{null}}")  Optional<String> secret,
      @Value("${auth.expires:#{null}}") Optional<Long> expiration) {
      this.secret = secret.orElse("reallysecret");
      this.expiration = expiration.orElse(3600l);
